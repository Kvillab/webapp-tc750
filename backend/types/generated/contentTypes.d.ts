...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Articulo (Explora y Aprende)';
...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Evento (Vida en Acci\u00F3n)';
    pluralName: 'eventos';
    singularName: 'evento';
  };
  options: {
...
export interface ApiExploraYAprendeExploraYAprende
  extends Struct.SingleTypeSchema {
  collectionName: 'explora_y_aprendes';
  info: {
    displayName: 'Explora y Aprende';
    pluralName: 'explora-y-aprendes';
    singularName: 'explora-y-aprende';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::explora-y-aprende.explora-y-aprende'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nombreSitio: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    links: Schema.Attribute.Component<'header.link-navegacion', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
...
export interface ApiInvestigacionInvestigacion
  ...
  info: {
    displayName: 'Investigacion (Sapere Aude)';
    pluralName: 'investigaciones';
    singularName: 'investigacion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::investigacion.investigacion'
    > &
      Schema.Attribute.Private;
    metodologia: Schema.Attribute.Enumeration<
      ['Mixta (Cualitativa y Cuantitativa)', 'Cualitativa', 'Cuantitativa']
    >;
    metricas: Schema.Attribute.Component<'cantidad.metrica', true>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'titulo'>;
...
export interface ApiPaginaPrincipalPaginaPrincipal
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    evento_destacado: Schema.Attribute.Relation<
      'oneToOne',
      'api::evento.evento'
    >;
...
export interface ApiSapereAudeSapereAude extends Struct.SingleTypeSchema {
  collectionName: 'sapere_audes';
  info: {
    displayName: 'Sapere Aude';
    pluralName: 'sapere-audes';
    singularName: 'sapere-aude';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSobreElTcuSobreElTcu extends Struct.SingleTypeSchema {
  collectionName: 'sobre_el_tcus';
  info: {
    displayName: 'Sobre el TCU';
    pluralName: 'sobre-el-tcus';
    singularName: 'sobre-el-tcu';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    compromiso: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sobre-el-tcu.sobre-el-tcu'
    > &
      Schema.Attribute.Private;
    objetivos: Schema.Attribute.Text;
    participacion: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVidaEnAccionVidaEnAccion extends Struct.SingleTypeSchema {
  collectionName: 'vida_en_accions';
  info: {
    displayName: 'Vida en Acci\u00F3n';
    pluralName: 'vida-en-accions';
    singularName: 'vida-en-accion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vida-en-accion.vida-en-accion'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subtitulo: Schema.Attribute.String;
